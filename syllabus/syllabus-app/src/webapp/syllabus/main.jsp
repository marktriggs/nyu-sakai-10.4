...
-->
				...
				<li>
					<span>
						...
						<h:commandLink action="#{SyllabusTool.processRedirectMain}">
			...
			<syllabus:syllabus_if test="#{SyllabusTool.syllabusItem.redirectURL}">
					...
					<t:dataList value="#{SyllabusTool.entries}" var="eachEntry" layout="simple">
						...
						<f:subview id="actionIcons" rendered="#{SyllabusTool.editAble == 'true'}">
							...
							<h:commandLink styleClass="editLink" action="#{eachEntry.processListRead}" title="#{msgs.goToItem} #{eachEntry.entry.title}"><f:verbatim><img src="/library/image/silk/pencil.png"/></f:verbatim></h:commandLink>
							<%/* 
						...
						<f:verbatim><a href="javascript:void(0)" </f:verbatim>
							...
							<f:subview id="dateInstructor" rendered="#{false}">
								<f:verbatim><span style="font-weight: normal; color: grey; float: right"></f:verbatim>
						...
						<f:verbatim><div></f:verbatim>
							...
							<h:dataTable value="#{eachEntry.attachmentList}" var="eachAttach" styleClass="indnt1">
								<h:column>
									...
									<f:subview id="removeItem" rendered="#{false}">
										<f:verbatim>
										&nbsp;
							...
							<f:subview id="instructorAddAttach" rendered="#{false}">
								<f:verbatim>
									<br/>
								</f:verbatim>
					...
					<syllabus:syllabus_if test="#{SyllabusTool.displayNoEntryMsg ? '' : 'false'}">
						<h:outputText value="#{msgs.syllabus_noEntry}" styleClass="instruction"/>			
						<f:verbatim>
